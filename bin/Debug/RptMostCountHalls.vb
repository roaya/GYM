...
Public Class RptMostCountHalls
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptMostCountHalls.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMostCountHalls
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMostCountHalls = New RptMostCountHalls()
        rpt.Site = Me.Site
        Return rpt
    End Function
