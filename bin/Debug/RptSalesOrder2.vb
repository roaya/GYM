...
Public Class RptSalesOrder2
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_P_HeaderReport2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptSalesOrder2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSalesOrder2 = New RptSalesOrder2()
        rpt.Site = Me.Site
        Return rpt
    End Function
