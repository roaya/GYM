...
Public Class RptMostNoCustToTrainer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptMostNoCustToTrainer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptMostNoCustToTrainer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMostNoCustToTrainer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMostNoCustToTrainer = New RptMostNoCustToTrainer()
        rpt.Site = Me.Site
        Return rpt
    End Function
