...
Public Class Report_Adjustments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.Report_Adjustments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Adjustments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Adjustments = New Report_Adjustments()
        rpt.Site = Me.Site
        Return rpt
    End Function
