...
Public Class RptEmployeesTasks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptEmployeesTasks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEmployeesTasks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEmployeesTasks = New RptEmployeesTasks()
        rpt.Site = Me.Site
        Return rpt
    End Function
