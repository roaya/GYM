...
Public Class Report_User_Log
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.Report_User_Log.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_User_Log
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_User_Log = New Report_User_Log()
        rpt.Site = Me.Site
        Return rpt
    End Function
