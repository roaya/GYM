Public Class ExpensesMaster
    ...
    Dim BSourceExpenses_Header As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Expenses_Header"
    Dim d As Date
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceExpenses_Header, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, , CountRecords)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceExpenses_Header, "Expense_Category_Name")
            ExpenseMasterDesc.TextBox1.DataBindings.Add("Text", BSourceExpenses_Header, "Expense_Category_Desc")

            SSource = BSourceExpenses_Header
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Try
            If MasterField1.TextBox1.Text = "" Then
                cls.MsgExclamation("«œŒ· «”„ »‰œ «·„’—Ê›« ", "please enter expenses category")
            Else
                Gcls.SaveRecord()
            End If
        Catch ex As Exception
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceExpenses_Header, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BSourceExpenses_Header.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
