Public Class ExpensesDetails
    ...
    '-------------------------------
    Public SearchExpenseDetailID As Integer
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            cls.RefreshData("Expenses_Header")
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceExpenses_Details, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)
            ...
            ExpenseCategoryID.DataSource = MyDs
            ExpenseCategoryID.DisplayMember = "Expenses_Header.Expense_Category_Name"
            ExpenseCategoryID.ValueMember = "Expenses_Header.Expense_Category_ID"
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Try
            If ExpenseCategoryID.Text = "" Then
                cls.MsgExclamation("«œŒ· »‰œ «·„’—Ê›« ", "please enter expense name")
                'ElseIf EmployeeID.Text = "" Then
                '    cls.MsgExclamation("«Œ — «”„ «·„ÊŸ›", "please select employee name")
                'ElseIf ExpenseValue.Value = 0 Then
                '    cls.MsgExclamation("«œŒ· ﬁÌ„… «·„’—Ê›", "please enter expense value")
