Public Class Banks
    ...
    Dim BSourceBanks As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Banks"
    Dim d As Date
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceBanks, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceBanks, "Bank_Name")
            Address.TextBox1.DataBindings.Add("Text", BSourceBanks, "Address")
            GenericDesc.TextBox1.DataBindings.Add("Text", BSourceBanks, "Generic_Desc")

            SSource = BSourceBanks
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceBanks, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
