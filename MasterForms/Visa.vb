Public Class Visa
    ...
    Dim tbl1 As New GeneralDataSet.Banks_AccountsDataTable
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            cls.RefreshData("select * from Banks_Accounts", tbl1)
            ...
            AccountID.DataSource = tbl1
            AccountID.DisplayMember = "Account_Number"
            AccountID.ValueMember = "Account_ID"
    ...
    Private Sub BtnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnNew.Click
        Try
            MyDs.Tables("Visa").Columns("Created_Date").DefaultValue = Now.ToString("MM/dd/yyyy")
            Gcls.NewRecord()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Try
            If MasterField1.TextBox1.Text = "" Or AccountID.Text = "" Then
                cls.MsgComplete()
            Else
                Gcls.SaveRecord()
            End If
