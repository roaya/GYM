Public Class Extra
    ...
    Dim BsourceExtra_Categories As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Extra_Categories"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BsourceExtra_Categories, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)

            '-------------------------------
            'Must Specify Window Title 
            '-------------------------------

            Gcls.SetWTitle = "»Ì«‰«  »œ·«  «·„ÊŸ›"
            Me.Text = Gcls.SetWTitle

            MasterField1.TextBox1.DataBindings.Add("Text", BsourceExtra_Categories, "Category_Name")
            GenericDesc.TextBox1.DataBindings.Add("Text", BsourceExtra_Categories, "Generic_Desc")


            SSource = BsourceExtra_Categories
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BsourceExtra_Categories, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BsourceExtra_Categories.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
    ...
    Private Sub Genericdesc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub type_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GenericDesc.Load
