Public Class SpecialCategories
    ...
    Dim bsourcespecial As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Special_Categories"
    '-------------------------------
    Public SearchSpecialID As Integer
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, bsourcespecial, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", bsourcespecial, "category_name")
            value.DataBindings.Add("value", bsourcespecial, "value")
            Genericdesc.TextBox1.DataBindings.Add("Text", bsourcespecial, "Generic_Desc")
            percent.DataBindings.Add("value", bsourcespecial, "coach_percent")

            SSource = bsourcespecial
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Try
            ...
            ElseIf value.Value = 0 Or percent.Value = 0 Then
                cls.MsgComplete()
            Else
                Gcls.SaveRecord()
            End If
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(bsourcespecial, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
