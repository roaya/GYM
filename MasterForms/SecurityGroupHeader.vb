Public Class SecurityGroupHeader
    ...
    Dim BSourceSecurityHeader As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Security_Group_Header"
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceSecurityHeader, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)

            '-------------------------------
            'Must Specify Window Title 
            '-------------------------------

            Gcls.SetWTitle = "„Ã„Ê⁄«  «·’·«ÕÌ« "
            Me.Text = Gcls.SetWTitle

            MasterField1.TextBox1.DataBindings.Add("Text", BSourceSecurityHeader, "Group_Name")
            GenericDesc.TextBox1.DataBindings.Add("Text", BSourceSecurityHeader, "Generic_Desc")

            SSource = BSourceSecurityHeader

            '-------------------------------
            'Must Specify search field
            '-------------------------------

            RVal = "Security_Group_Name"
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceSecurityHeader, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BSourceSecurityHeader.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
