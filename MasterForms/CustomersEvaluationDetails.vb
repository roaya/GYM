Public Class CustomersEvaluationDetails

    Dim Gcls As GeneralSp.NewMasterForms
    Dim B_EndLoad As Boolean = False
    Dim BsourceCustomers_Evaluation_Details As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Customers_Evaluation_Details"
    '-------------------------------
    Dim tbl As New GeneralDataSet.Customers_EvaluationDataTable
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            cls.RefreshData("select * from customers_evaluation", tbl)
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BsourceCustomers_Evaluation_Details, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BsourceCustomers_Evaluation_Details, "Evaluation_Detail_Name")
            EvaluationID.DataSource = tbl
            EvaluationID.DisplayMember = "Evaluation_Name"
            EvaluationID.ValueMember = "Evaluation_Id"
            EvaluationID.DataBindings.Add("selectedvalue", BsourceCustomers_Evaluation_Details, "Evaluation_ID")
            GenericDesc.TextBox1.DataBindings.Add("Text", BsourceCustomers_Evaluation_Details, "Generic_Desc")

            SSource = BsourceCustomers_Evaluation_Details

            '-------------------------------
            'Must Specify search field
            '-------------------------------

            RVal = "Evaluation_Detail_Name"
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BsourceCustomers_Evaluation_Details, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BsourceCustomers_Evaluation_Details.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
