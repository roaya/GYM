Public Class Halls
    ...
    Dim bsourcehalls As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Halls"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, bsourcehalls, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", bsourcehalls, "hall_name")
            Number.TextBox1.DataBindings.Add("Text", bsourcehalls, "hall_number")
            GenericDesc.TextBox1.DataBindings.Add("Text", bsourcehalls, "Description")


            SSource = bsourcehalls
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(bsourcehalls, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
