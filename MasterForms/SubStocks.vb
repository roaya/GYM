Public Class SubStocks
    ...
    Dim BSourcePharmacy As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Sub_Stocks"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourcePharmacy, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)

            '-------------------------------
            'Must Specify Window Title 
            '-------------------------------

            Gcls.SetWTitle = "»Ì«‰«  «·Œ“‰Â"
            Me.Text = Gcls.SetWTitle

            MasterField1.TextBox1.DataBindings.Add("Text", BSourcePharmacy, "sub_Stock_name")
            Employee.DataSource = tbl
            Employee.DisplayMember = "employee_name"
            Employee.ValueMember = "employee_id"
            Employee.DataBindings.Add("selectedvalue", BSourcePharmacy, "employee_id")
            Genericdesc.TextBox1.DataBindings.Add("Text", BSourcePharmacy, "description")


            SSource = BSourcePharmacy
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Try
            If MasterField1.TextBox1.Text = "" Or Employee.SelectedValue = Nothing Then
                cls.MsgComplete()
            Else
                Gcls.SaveRecord()
            End If
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourcePharmacy, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
