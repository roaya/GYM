Public Class TrainerDetails
    ...
    Dim bsourceTrainerDetails As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Trainers_Details"
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Gcls = New GeneralSp.NewMasterForms(TName, bsourceTrainerDetails, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, , CountRecords)

        '-------------------------------
        'Must Specify Window Title 
        '-------------------------------

        Gcls.SetWTitle = "»Ì«‰«  «·’Ìœ·ÌÂ"
        Me.Text = Gcls.SetWTitle
        Trainer.DataSource = tbl1
        Trainer.DisplayMember = "employee_name"
        Trainer.ValueMember = "employee_id"
        Trainer.DataBindings.Add("selectedvalue", bsourceTrainerDetails, "trainer_id")
        SubscriptionType.DataSource = tbl2
        SubscriptionType.DisplayMember = "subscription_name"
        SubscriptionType.ValueMember = "subscription_id"
        SubscriptionType.DataBindings.Add("selectedvalue", bsourceTrainerDetails, "subscription_id")
        NO_Custs.DataBindings.Add("value", bsourceTrainerDetails, "no_customers")

        SSource = bsourceTrainerDetails
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Try
            If Trainer.SelectedValue = Nothing Or SubscriptionType.SelectedValue = Nothing Then
                cls.MsgComplete()
            Else
                Gcls.SaveRecord()
            End If
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(bsourceTrainerDetails, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            bsourceTrainerDetails.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
