Public Class EmployeesRewards
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceEmployees_Rewards, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, , CountRecords)

            '-------------------------------
            'Must Specify Window Title 
            '-------------------------------

            Gcls.SetWTitle = "„ﬂ«›«  «·„ÊŸ›Ì‰"
            ...
            DataGridView1.Columns(2).HeaderText = " «—ÌŒ «·„ﬂ«›«…"
            DataGridView1.Columns(3).HeaderText = "”»» «·„ﬂ«›«…"
            DataGridView1.Columns(4).HeaderText = "ﬁÌ„… «·„ﬂ«›«…"
    ...
    Private Sub BtnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnNew.Click
        Try
            MyDs.Tables("Employees_rewards").Columns("reward_Date").DefaultValue = Today
            Gcls.NewRecord()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
