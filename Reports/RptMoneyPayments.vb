...
Public Class RptMoneyPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptMoneyPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMoneyPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMoneyPayments = New RptMoneyPayments()
        rpt.Site = Me.Site
        Return rpt
    End Function
