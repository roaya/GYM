Public Class ReportBanksBalance
    ...
    Private Sub FrmCustomerTeansaction_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cls.RefreshData("Banks_Accounts", " Account_Number ")
        cmd.CommandText = "select * from procedure_master where Procedure_Category = N'بنوك'"
        da.Fill(TblBanks)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            cmd.CommandText = "SELECT (select logo from app_preferences) as logo,Procedure_Desc as Tran_Desc,Procedure_Date as Tran_Date,Procedure_Value as Tran_Value from Procedure_Details where Procedure_Date between '" & date1.ToString("MM/dd/yyyy") & "'  and   '" & date2.ToString("MM/dd/yyyy") & "' and (from_procedure_master_id = " & AccountID.SelectedValue & " or to_procedure_master_id = " & AccountID.SelectedValue & ")"
