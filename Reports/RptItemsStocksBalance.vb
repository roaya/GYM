...
Public Class RptItemsStocksBalance
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptItemsStocksBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptItemsStocksBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptItemsStocksBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptItemsStocksBalance = New RptItemsStocksBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
