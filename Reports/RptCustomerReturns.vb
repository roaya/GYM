...
Public Class RptCustomerReturns
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptCustomerReturns.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCustomerReturns
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCustomerReturns = New RptCustomerReturns()
        rpt.Site = Me.Site
        Return rpt
    End Function
