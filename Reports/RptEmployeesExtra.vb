...
Public Class RptEmployeesExtra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptEmployeesExtra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEmployeesExtra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEmployeesExtra = New RptEmployeesExtra()
        rpt.Site = Me.Site
        Return rpt
    End Function
