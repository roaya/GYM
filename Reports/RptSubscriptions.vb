...
Public Class RptSubscriptions
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptSubscriptions.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSubscriptions
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSubscriptions = New RptSubscriptions()
        rpt.Site = Me.Site
        Return rpt
    End Function
