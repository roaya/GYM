...
Public Class RptMasterRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptMasterRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMasterRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMasterRecord = New RptMasterRecord()
        rpt.Site = Me.Site
        Return rpt
    End Function
