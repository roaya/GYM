...
Public Class RptEmpPayingSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.RptEmpPayingSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEmpPayingSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEmpPayingSlip = New RptEmpPayingSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
