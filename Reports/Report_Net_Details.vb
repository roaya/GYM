...
Public Class Report_Net_Details
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GYM.Report_Net_Details.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Net_Details
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Net_Details = New Report_Net_Details()
        rpt.Site = Me.Site
        Return rpt
    End Function
